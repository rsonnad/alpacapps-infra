...
> Works with Ollama, msty, or both. Zero cloud cost, fully offline-capable.
...
- **24GB+ Mac**: Gemma 3 27B (Q4) + Qwen 3.5 9B (Q8)
...
### As AI API Backend
Point your edge functions at `http://localhost:11434/v1/chat/completions` (OpenAI-compatible). Zero token cost.
...
ollama stop gemma3:12b          # Unload from RAM
...
After this, any device on the network can use `http://YOUR_MAC_IP:11434` as an AI API.
