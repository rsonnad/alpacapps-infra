...
-- Dark header, prominent email callout, orange CTA, art banner, My Brand branding.
-- Sender: ai_assistant (so replies route to the AI assistant).
...
Questions? Just reply to this email — our AI assistant, is happy to help.
