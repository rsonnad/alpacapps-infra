...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const adminRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'YOUR_PROJECT_NAME Team <team@YOUR_DOMAIN>',
        to: [ADMIN_EMAIL],
        ...
        html: `
          ...
          <div style="text-align: center; padding: 16px;"><img src="https://YOUR_DOMAIN/assets/branding/logo-white-transparent.png" alt="" style="height: 40px; margin: 0 8px;" /><img src="https://YOUR_DOMAIN/assets/property-highlights/hero.jpg" alt="" style="height: 80px; border-radius: 8px; margin: 0 8px;" /></div>
        `,
...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
  <div style="background: #1a1a2e; padding: 24px; text-align: center; border-radius: 8px 8px 0 0;">
    <img src="https://YOUR_DOMAIN/assets/branding/logo-white-transparent.png" alt="My Brand" style="height: 50px;" />
  ...
  <div style="text-align: center; padding: 16px;">
    <img src="https://YOUR_DOMAIN/assets/branding/logo-white-transparent.png" alt="" style="height: 35px; margin: 0 8px;" />
    <img src="https://YOUR_DOMAIN/assets/property-highlights/hero.jpg" alt="" style="height: 60px; border-radius: 8px; margin: 0 8px;" />
  </div>
</div>`,
          text: `Hi ${firstName},
